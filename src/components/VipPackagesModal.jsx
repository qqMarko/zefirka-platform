...
const VipPackagesModal = ({ setShowVipModal, userRole, openWalletWithAmount }) => {
    ...
    const clientPackages = [
        { 
            id: 'premium_client', title: 'GUEST', price: '499', days: '30 днів', 
            color: '#4caf50', icon: <ShieldCheck size={36} color="#4caf50" />, 
            desc: 'Базовий статус для клієнтів що цінують свій час.', 
            topFeatures: ['Все що є у безкоштовних користувачів'], 
            features: [
                '✓ Значок верифікованого клієнта в чаті 🏅',
                'Пріоритет у сайдбарі моделі 🚀',
                'Додавання анкет в Обране 🩷',
                'Доступ до розділу Арбітраж ⚖️',
                'Точний час останнього виходу моделі онлайн 🕐',
            ], 
            isPopular: false 
        },
        { 
            id: 'priority_chat', title: 'PRIORITY', badge: 'ХІТ', price: '999', days: '30 днів', 
            color: '#ffc107', icon: <Zap size={36} color="#ffc107" />, 
            desc: 'Пріоритетне спілкування та ексклюзивні можливості.', 
            topFeatures: ['💎 Усі переваги статусу GUEST'], 
            features: [
                'Виділення повідомлень золотим кольором в чаті 🎨',
                'Читання повідомлень — клієнт бачить "Прочитано" ✓✓',
                'Сповіщення коли обрана модель з\'явилась онлайн 🔔',
                'Можливість залишити відгук на анкеті моделі 💬',
                'Вищий пріоритет для розгляду арбітражних скарг ⚖️',
            ], 
            isPopular: true 
        },
        { 
            id: 'concierge', title: 'CONCIERGE', badge: 'КЛУБ', price: '1999', days: '30 днів', 
            color: '#ff007f', icon: <Sparkles size={36} color="#ff007f" />, 
            desc: 'Абсолютна ексклюзивність. Закритий клуб.', 
            topFeatures: ['👑 Усі переваги статусу PRIORITY'], 
            features: [
                '👑 VIP Лаунж — ексклюзивний доступ до топ-моделей',
                'Режим "Привид" — перегляд анкет анонімно 😶‍🌫️',
                'Персональний менеджер 24/7 🤴',
                'Приховане прочитання повідомлень',
                'Найвищий пріоритет для розгляду арбітражних скарг 🚀',
                'Відшкодування коштів у спірних ситуаціях 💵',
            ], 
            isPopular: false, isRgb: true 
        }
    ];
