...
const DisputeSidebar = ({ disputes, activeDispute, setActiveDispute, setIsCreatingDispute, userRole, setVerdictResultModal, accent }) => {
                ...
                {filteredDisputes.length === 0 ? (
                    ...
                    filteredDisputes.map(d => (
                        <div 
                            ...
                            style={{ padding: '15px', borderBottom: '1px solid rgba(255,255,255,0.05)', cursor: 'pointer', background: activeDispute?._id === d._id ? `${accent}15` : 'transparent', borderLeft: activeDispute?._id === d._id ? `3px solid ${accent}` : '3px solid transparent' }}
